...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="/mixcloud/all-videos"><button type="button" class="close">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/mixcloud/video-to-playlist-store') }}" method="POST" id="VideoToPlaylistForm">
                        @csrf
                ...
                <div class="modal-footer">
                    <a href="/mixcloud/all-videos"><button type="button" class="btn mb-2 btn-secondary">Close</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
       ...
       <script>
        $(document).ready(function() {
            $(document).on("submit", "#VideoToPlaylistForm", function(e) {

                e.preventDefault();

                let formData = new FormData($('#VideoToPlaylistForm')[0]);

                $.ajax({
                    method: "post",
                    url: "/mixcloud/video-to-playlist-store",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        if (response.status == 400) {
                            ...
                            // this.reset();
                            $('#VideoToPlaylistForm').find('input').val('');
