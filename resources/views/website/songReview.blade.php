    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="/mixcloud/all-songs" class="close">
            ...
            <div class="modal-body">
                ...
                <form action="{{url('/mixcloud/song-review-store')}}" method="post" id="ReviewForm">
                    @csrf
                    ...
                    <input type="text" name="song" value="{{$id}}" hidden>
                </form>
            </div>
            <div class="modal-footer">
                <a href="/mixcloud/all-songs" class="btn mb-2 btn-secondary">Close</a>
            </div>
        </div>
    </div>
</div>
      ...
      <script>
        $(document).ready(function () {
           $(document).on("submit", "#ReviewForm", function (e) {
               ...
               $.ajax({
                   method: "post",
                   url: "/mixcloud/song-review-store",
                   data: formData,
                   contentType: false,
                   processData: false,
