                            ...
                            <div class="card-body">
                                <form action="{{url('/dashboard/song-store')}}" method="POST" class="needs-validation" id="AddSongForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Title</label>
                                        <input type="text" class="form-control" value="{{$findSong->title}}" name="title" placeholder="Type song title">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="example-textarea">Lyrics</label>
                                        <textarea class="form-control" id="example-textarea" rows="4" style="height: 91px;" name="lyrics">{{$findSong->lyrics}}</textarea>
                                      </div>
                                    <div class="form-group mb-3">
                                        <label>Track no</label>
                                        <input type="number" value="{{$findSong->track}}" class="form-control" name="track">
                                      </div>
                                      <div class="form-group mb-3">
