        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="alert alert-success alert-dismissible fade show d-none" role="alert">
                    <strong class="text-dark">Your video add successfully</strong><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="{{url('/dashboard/video-store')}}" method="post" enctype="multipart/form-data" id="AddVideoForm">
                                 @csrf
                                 <div class="alert alert-warning d-none" role="alert" id="save_error"></div>
                                 <div class="form-group mb-3">
                                    <label>Title</label>
                                    <input type="text" class="form-control" name="title" placeholder="Type video title">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="example-textarea">Description</label>
                                    <textarea class="form-control" id="example-textarea" rows="4" style="height: 91px;" name="description"></textarea>
                                  </div>
                                  <div class="form-group mb-3">
...
<script>
    $(document).ready(function () {
       $(document).on("submit", "#AddVideoForm", function (e) {
           ...
           let formData = new FormData($('#AddVideoForm')[0]);

           $.ajax({
               method: "post",
               url: "/dashboard/video-store",
               data: formData,
               contentType: false,
               processData: false,
